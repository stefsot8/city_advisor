...
import gr.hua.dit.oopii.ss.weather.OpenWeatherMap;
import gr.hua.dit.oopii.ss.wikipedia.MediaWiki;;
...
* @param appid Your API key of the OpenWeatherMap.*/ 
 ...
 public static double RetrieveLat(String city, String country, String appid) throws  IOException {
	 ObjectMapper mapper = new ObjectMapper(); 
	 OpenWeatherMap weather_obj = mapper.readValue(new URL("http://api.openweathermap.org/data/2.5/weather?q="+city+","+country+"&APPID="+appid+""), OpenWeatherMap.class);
	 return weather_obj.getCoord().getLat();
 }
 
 public static double RetrieveLon(String city, String country, String appid) throws  IOException {
	 ObjectMapper mapper = new ObjectMapper(); 
	 OpenWeatherMap weather_obj = mapper.readValue(new URL("http://api.openweathermap.org/data/2.5/weather?q="+city+","+country+"&APPID="+appid+""), OpenWeatherMap.class);
